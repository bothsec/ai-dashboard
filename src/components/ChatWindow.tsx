    ...
    <div className="flex-1 flex flex-col h-full min-h-0 overflow-hidden relative">
      ...
      >
        {activeChat && activeChat.messages.length === 0 ? (
          /* Empty state */
          <div className="h-full flex flex-col items-center justify-center text-center pt-12 md:pt-20 pb-8">
            {/* Logo/Brand */}
            <div className="relative mb-8">
              <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-3xl md:rounded-4xl flex items-center justify-center shadow-2xl shadow-indigo-500/30 animate-in zoom-in duration-500">
